...
export class FirebaseAuthService {
  ...
  private _redirectResult: Subject<any> = new Subject<any>();
  public $redirectResult: Observable<any> = this._redirectResult.asObservable();
  ...
  constructor(
    ...
    .then((result) => {
      ...
      if (result.user) {
        ...
        this._redirectResult.next(result);
      }
    }, (error) => {
      this._redirectResult.next({error: error.code});
    });
  }
